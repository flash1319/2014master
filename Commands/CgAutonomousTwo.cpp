...
CgAutonomousTwo::CgAutonomousTwo() {
	...
	//The robot waits the remaining time of autonomous until the hot goal changes
	AddSequential(new CmdWait(AUTONOMOUS_WAIT_AFTER_DEPLOYMENT));
