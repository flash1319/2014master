...
CgAutonomousSix::CgAutonomousSix() {
	...
	//Waits until the kinect recognizes the operator signalling the hot goal or the hot goal to change
	AddSequential(new CmdWaitForHotGoalKinect());
