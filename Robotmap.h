...
const float LOADER_PULL_BALL_TIME				= 0.7;
...
const float SHOOTER_MOTOR_SPEED					= -1.0;			//Todo: Set to a good amount
const float SHOOTER_MOTOR_REVERSE_SPEED			= 0.75;
...
const float SHOOTER_WAIT_BEFORE_STOP			= 0.15;
